...
#define LOG_ALWAYS(...)                                                        \
  do {                                                                         \
    switch (log_check(__FILE__, __LINE__, LOG_LEVEL_ALWAYS, LOG_LEVEL_FILE)) { \
    case 2:                                                                    \
...
#define LOG_ERROR(...)                                                         \
  do {                                                                         \
    switch (log_check(__FILE__, __LINE__, LOG_LEVEL_ERROR, LOG_LEVEL_FILE)) {  \
    case 2:                                                                    \
      fprintf(fd, __VA_ARGS__);                                                \
    case 1:                                                                    \
      printf(__VA_ARGS__);                                                     \
...
#define LOG_WARN(...)                                                          \
  do {                                                                         \
    switch (log_check(__FILE__, __LINE__, LOG_LEVEL_WARN, LOG_LEVEL_FILE)) {   \
    case 2:                                                                    \
      fprintf(fd, __VA_ARGS__);                                                \
    case 1:                                                                    \
      printf(__VA_ARGS__);                                                     \
...
#define LOG_INFO(...)                                                          \
  do {                                                                         \
    switch (log_check(__FILE__, __LINE__, LOG_LEVEL_INFO, LOG_LEVEL_FILE)) {   \
    case 2:                                                                    \
      fprintf(fd, __VA_ARGS__);                                                \
    case 1:                                                                    \
      printf(__VA_ARGS__);                                                     \
...
#define LOG_DEBUG(...)                                                         \
  do {                                                                         \
    switch (log_check(__FILE__, __LINE__, LOG_LEVEL_DEBUG, LOG_LEVEL_FILE)) {  \
    case 2:                                                                    \
      fprintf(fd, __VA_ARGS__);                                                \
    case 1:                                                                    \
      printf(__VA_ARGS__);                                                     \
 ...
 * prints the log header fname is assumed to be a string literal, as it should
 * be a C-string defined by __FILE__ The pointer passed is assumed to be valid
 * in global scope once the calling function returns
 */
