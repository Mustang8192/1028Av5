...
void _1028A::comp::auton::leftSide() {
  // Left Side
...
void _1028A::comp::auton::rightSide() {
  // Right Side
  flywheelMode = 2;
  fwtarget = 119;
  task::start("fw", flywheel::startFlywheelTask);
...
void _1028A::comp::auton::winPoint() {
  // Solo Win Point
  fwtarget = 105;
  task::start("fw", flywheel::startFlywheelTask);
  pros::Intake.move(127);
...
void _1028A::comp::auton::skills() {
  ...
  pros::Rotation.reset_position();
  pid::forward(2800, 48, 1, 4000);
  pros::delay(1000);
  pid::turn(-62, 127, 1, 1000);
  pid::turn(-62, 127, 1, 500);
  pid::turn(-62, 127, 1, 250);
  pid::turn(-62, 127, 1, 100);
  pros::delay(700);
  pros::Intake.move(-127);
  pros::delay(140);
  fwtarget = 95;
  ...
  pid::turn(-93, 127, 1, 1000);
  pid::turn(-93, 127, 1, 500);
  pid::turn(-93, 127, 1, 250);
  pid::turn(-93, 127, 1, 100);
  pros::delay(700);
  pros::Intake.move(-127);
  pros::delay(140);
  fwtarget = 103;
