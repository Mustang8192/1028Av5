...
void _1028A::robot::auton(){
    ...
    if (autonSelect == 1){
        ...
        time::forward(-127, 600);
        fwtarget = 98;
        pid::turn(41, 127, 1, 1000);
        pid::turn(41, 127, 1, 500);
        pid::turn(41, 127, 1, 250);
        pid::turn(41, 127, 1, 100);
        pros::Intake.move(127);
        time::forward(38, 3150);
        pros::delay(900);
        ...
        pros::Intake.brake();
        pros::delay(500);
        pid::turn(6, 127, 1, 1000);
        pid::turn(6, 127, 1, 500);
        pid::turn(6, 127, 1, 250);
        pid::turn(6, 127, 1, 100);
        fwtarget = 95;
        pros::Intake.move(127);
        pros::delay(500);
        time::forward(25, 4300);
        pros::delay(2000);
        pid::turn(-104.5, 127, 1, 1000);
        pid::turn(-104.5, 127, 1, 500);
        pid::turn(-104.5, 127, 1, 250);
        pid::turn(-104.5, 127, 1, 100);
        pros::delay(700);
        pros::Intake.move(-127);
        pros::delay(165);
        fwtarget = 98;
