...
void _1028A::robot::auton() {
  ...
  if (autonSelect == 1) {
    ...
    pros::delay(550);
    time::forward(127, 60);
    pid::turn(-4, 127, 1, 1200);
    pid::turn(-4, 127, 1, 600);
    pid::turn(-4, 127, 1, 250);
    pid::turn(-4, 127, 1, 100);
    // time::forward(127, 725);
    pros::Rotation.reset_position();
    pid::forward(1500, 127, 1.5, 1200);
    pid::turn(-5, 127, 1, 1200);
    ...
    // time::forward(38, 3100);
    pros::Rotation.reset_position();
    pid::forward(3200, 38, 1, 4000);
    pros::delay(2000);
    pid::turn(-66, 127, 1, 1000);
    pid::turn(-66, 127, 1, 500);
    pid::turn(-66, 127, 1, 250);
    pid::turn(-66, 127, 1, 100);
    pros::delay(700);
    pros::Intake.move(-127);
    pros::delay(140);
    fwtarget = 100;
    ...
    pid::turn(-95, 127, 1, 1000);
    pid::turn(-95, 127, 1, 500);
    pid::turn(-95, 127, 1, 250);
    pid::turn(-95, 127, 1, 100);
    pros::delay(700);
    pros::Intake.move(-127);
    pros::delay(140);
    fwtarget = 110;
    ...
    pros::Rotation.reset_position();
    pid::forward(1000, 40, 1.5, 3000);
    pid::turn(-189, 127, 1, 1000);
    pid::turn(-189, 127, 1, 500);
    pid::turn(-189, 127, 1, 250);
    pid::turn(-189, 127, 1, 100);
    fwtarget = 100;
    pros::delay(700);
    pros::Intake.move(-127);
    pros::delay(140);
