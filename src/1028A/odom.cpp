...
void _1028A::odom::set_physical_distances(
...
void _1028A::odom::set_position(float X_position, float Y_position,
...
void _1028A::odom::update_position(float ForwardTracker_position,
                                   float SidewaysTracker_position,
                                   float orientation_deg) {
