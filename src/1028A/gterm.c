 ...
 * height = 240 / 20 = 12 lines of text, but there are 2 bytes padding on all
 * but the last line so 11 lines of text
 */
...
void gterm_init(lv_obj_t *page) {
  ...
  gterm_act_lines =
      (lv_obj_get_height(page) + GTERM_FONT_PAD) / GTERM_FONT_HEIGHT;
