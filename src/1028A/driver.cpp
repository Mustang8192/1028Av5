...
void _1028A::driver::faultDetection(void *ptr) {
  int faultDetected = 0;
  while (1) {
    if (pros::LeftBack.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Left Back Fault");
      faultDetected = 1;
    }
    if (pros::LeftMid.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Left Mid Fault");
      faultDetected = 1;
    }
    if (pros::LeftFront.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Left Front Fault");
      faultDetected = 1;
    }
    if (pros::RightBack.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Right Back Fault");
      faultDetected = 1;
    }
    if (pros::RightMid.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Right Mid Fault");
      faultDetected = 1;
    }
    if (pros::RightFront.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Right Front Fault");
      faultDetected = 1;
    }
    if (pros::FlyWheel.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "FlyWheel Fault");
      faultDetected = 1;
    }
    if (pros::Intake.get_faults() != 0x00 && faultDetected == 0) {
      pros::mainController.print(1, 1, "Intake Fault");
      faultDetected = 1;
    }
